...
public class ResponseTable {
    private Map<Opcode, Map<ResponseCondition, String>> responseTable;
     ...
     */
    public ResponseTable(String fileName) {
     ...
     * @param outcome A compound object consisting of a ResponseTable Condition, which determines the
     *                response out of the set to use, and a variable amount of parameters,
     *                which will be added to the response template.
     * @return The formatted response.
     */
    String getResponse(Opcode op, ResponseDetails outcome) {
        return getResponse(op, outcome.getCondition(), outcome.getInserts());
    }

    private String getResponse(Opcode op, ResponseCondition outcome, String[] resInserts) {
